...
<div id="card">
    <div class="decoration">
        <div id="gradient" />
		<svg width="329" height="530" viewBox="0 0 329 530" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M7.42172 0.463989V8.44467H0.352783V529.375H315.373V528.67H1.05752V9.1494H8.12646V1.16872L328.667 1.16873V0.463989H7.42172Z" fill="white" fill-opacity="0.39"/>
			<path d="M0.705151 0.816357L0.705181 5.08021H4.95525V0.816357H0.705151Z" fill="white" fill-opacity="0.39"/>
		</svg>
    </div> 
